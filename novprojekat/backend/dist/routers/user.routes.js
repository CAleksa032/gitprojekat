...
userRouter.route('/teachers').get((req, res) => new user_controller_1.UserController().teachers(req, res));
userRouter.route('/teachersApprove').post((req, res) => new user_controller_1.UserController().teachersApprove(req, res));
