...
@Component({
  selector: 'app-register-ti',
  templateUrl: './register-ti.component.html',
  styleUrls: ['./register-ti.component.css']
})
export class RegisterTIComponent implements OnInit{
  constructor(private userService: UserService,  private router: Router) { this.type = 2 }
  ...
  register(){
      this.userService.registerTeacherI(
        this.username, 
        this.password, 
        this.name, 
        this.lastname,
        ...
        if(respObj['message'] == 'ok'){
          ...
          this.router.navigate(['/registerTeacherII']);
